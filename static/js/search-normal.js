...
document.getElementById('searchButton').addEventListener('submit', function(event) {
    ...
    const end = document.getElementById('final-destination').values;
    ...
    const query_string = `fromEntityId=${origin}&toEntityid=${end}&minimumPrice=${min_price}&max_price=${max_price}&
